...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST['buscar'])){
        ...
        $idDistrito = trim($_POST['idDistrito']);
        $nombreDistrito = trim($_POST['nombreDistrito']);
        $idEstado = trim($_POST['idEstado']);

        $actualizado = actualizarDistrito($idDistrito, $nombreDistrito, $idEstado);
    ...
    <div class="principal-container">
        ...
        <?php if(!$busquedaRealizada && !$actualizacionRealizada): ?>
            ...
            <form action="" method="POST">
                ...
                <h3 class="form-title">Buscar Distrito</h3>

                <div class="form-inputs-container">
                    <div>
                        <p class="form-input-title">ID:</p>
                        <input type="text" name="idDistrito" placeholder="ID DEL DISTRITO" required>
                    </div>
                </div>

                <input type="submit" name="buscar" value="Buscar" class="submit-button">
                <a href="distrito.php" class="cancel-button">Cancelar</a>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-inputs-container">
                        <input type="hidden" name="idDistrito"
                            value="<?php
                                        echo $distrito['ID_DISTRITO'];
                                    ?>" required>

                        <div>
                            <p class="form-input-title">Nombre</p>
                            <input type="text" name="nombreDistrito" placeholder="NOMBRE DEL DISTRITO"
                                value="<?php
                                        echo $distrito['NOMBRE_DISTRITO'];
                                        ?>" required>
                        </div>
                            ...
                            <option value="">Seleccione un Estado</option>
                                <?php
                                    ...
                                    while($row = oci_fetch_assoc($estados)){
                                        ...
                                        if($distrito['ID_ESTADO'] == $row['ID_ESTADO']){
        ...
        <?php elseif($actualizacionRealizada && $actualizado): ?>
            ...
            <div class="db-message-container">
                ...
                <a href="distrito.php" class="continue-button">Aceptar</a>
            </div>
