...
<head>
    ...
    <title>Lista de Areas de Trabajo</title>
</head>
<body>
    ...
    <div class="principal-container">                  
        ...
        <div class="options">        
            <a href="areaTrabajo.php" class="go-back-button">Regresar</a>      
                ...
                <tbody>
                    ...
                    <?php
                        while ($row = oci_fetch_assoc($areasTrabajo)){
                            ...
                            echo "<tr>";
                            echo "<td>" . $row['ID_AREA_TRABAJO'] . "</td>";
    ...
    <script>
        function filtrarTabla() {
            ...
            let filas = document.querySelectorAll('#tablaAreasTrabajo tbody tr');
