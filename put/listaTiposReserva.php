...
<head>
    ...
    <title>Lista de Tipos de Reservas</title>
</head>
<body>
                ...
                <tbody>
                    ...
                    <?php
                        while ($row = oci_fetch_assoc($tiposReserva)){
                            ...
                            echo "<tr>";
                            echo "<td>" . $row['ID_TIPO_RESERVA'] . "</td>";
    ...
    <script>
        function filtrarTabla() {
            ...
            let filas = document.querySelectorAll('#tablaTiposReserva tbody tr');
