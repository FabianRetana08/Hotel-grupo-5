...
$categoriasProducto = obtenerCategoriasProducto();
?>
...
<head>
    ...
    <title>Lista de Categorias de Productos</title>
</head>
<body>
    ...
    <div class="principal-container">                  
        ...
        <?php if ($categoriasProducto): ?>

            <table id="tablaCategoriasProducto">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>NOMBRE</th>
                ...
                <tbody>
                    ...
                    <?php
                        while ($row = oci_fetch_assoc($categoriasProducto)){
    ...
    <script>
        function filtrarTabla() {
            ...
            let filas = document.querySelectorAll('#tablaCategoriasProducto tbody tr');
